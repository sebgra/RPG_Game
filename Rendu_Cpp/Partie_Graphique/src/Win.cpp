...
Win::Win() : QWidget()
{
    ...
    m_label = new QLabel(this); // label affichant le texte de partie gagnee
    ...
    m_label->setText("Vous avez gagné !"); // On insere le texte dans le label, puis on centre ce texte
